...
class TestHeatingDecisions:
    ...
    def test_should_activate_heating_when_zones_need_heat(
        self, mock_hass, sample_config, sample_zone_configs
    ):
        ...
        state_manager.get_zones_needing_heating = Mock(
            return_value=["living", "baby_bed"]
        )

        assert engine.should_activate_heating(state_manager) is True

    def test_should_not_activate_heating_when_no_zones_need_heat(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_should_not_activate_heating_when_mode_is_cooling(
        self, mock_hass, sample_config, sample_zone_configs
    ):
...
class TestCoolingDecisions:
    ...
    def test_should_activate_cooling_when_zones_need_cool(
        self, mock_hass, sample_config, sample_zone_configs
    ):
        ...
        state_manager = StateManager(mock_hass, config, sample_zone_configs)
        state_manager.get_zones_needing_cooling = Mock(
            return_value=["living", "master_bed"]
        )

        assert engine.should_activate_cooling(state_manager) is True

    def test_should_not_activate_cooling_when_no_zones_need_cool(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_should_not_activate_cooling_when_mode_is_heating(
        self, mock_hass, sample_config, sample_zone_configs
    ):
...
class TestIdleModeDecisions:
    ...
    def test_should_switch_to_idle_heating_when_satisfied_and_dampers_low(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_should_switch_to_idle_cooling_when_satisfied_and_dampers_low(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_should_not_switch_to_idle_when_zones_not_satisfied(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_should_not_switch_to_idle_when_dampers_not_low(
        self, mock_hass, sample_config, sample_zone_configs
    ):
...
class TestTargetHVACModeLogic:
    ...
    def test_get_target_hvac_mode_heating_active(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_get_target_hvac_mode_heating_idle(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_get_target_hvac_mode_cooling_active(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_get_target_hvac_mode_cooling_idle(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_get_target_hvac_mode_uses_automatic_idle_logic(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_heat_to_dry_transition_multiple_active_zones(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_cool_to_fan_transition_multiple_active_zones(
        self, mock_hass, sample_config, sample_zone_configs
    ):
...
class TestDamperCalculations:
    ...
    def test_damper_calculation_inactive_zones_get_zero(
        self, mock_hass, sample_config, sample_zone_configs
    ):
        ...
        positions = engine.calculate_damper_positions(
            state_manager, ["living"], HVACMode.HEAT
        )

        assert positions["baby_bed"] == 0

    def test_damper_calculation_trigger_zones_get_primary_percent(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_damper_calculation_isolated_non_trigger_gets_minimum(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_damper_calculation_heating_secondary_zones(
        self, mock_hass, sample_config, sample_zone_configs
    ):
        ...
        zone_below_target = Mock(
            is_active=True, isolation=False, current_temp=19.0, target_temp=20.0
        )

        # Zone above target but below max - should get overflow damper
        zone_above_target = Mock(
            is_active=True, isolation=False, current_temp=20.2, target_temp=20.0
        )
    ...
    def test_damper_calculation_cooling_secondary_zones(
        self, mock_hass, sample_config, sample_zone_configs
    ):
        ...
        zone_above_target = Mock(
            is_active=True, isolation=False, current_temp=25.0, target_temp=24.0
        )

        # Zone below target but above min - should get overflow damper
        zone_below_target = Mock(
            is_active=True, isolation=False, current_temp=23.8, target_temp=24.0
        )
        ...
        positions = engine.calculate_damper_positions(
            state_manager, ["living"], HVACMode.COOL
        )
...
class TestDecisionEngineEdgeCases:
    ...
    def test_unknown_hvac_mode_returns_dry(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_all_zones_isolated(self, mock_hass, sample_config):
        ...
        positions = engine.calculate_damper_positions(
            state_manager, ["zone1"], HVACMode.HEAT
        )
...
class TestHVACModeStabilityChecking:
    ...
    def test_should_switch_to_idle_respects_stability_check(
        self, mock_hass, sample_config, sample_zone_configs
    ):
        ...
        state_manager.get_time_since_last_hvac_mode_change = Mock(
    ...
    def test_should_switch_to_idle_allows_after_stability_period(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_should_switch_to_idle_allows_with_no_previous_changes(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_should_switch_to_idle_stability_check_with_cooling(
        self, mock_hass, sample_config, sample_zone_configs
    ):
...
class TestAlgorithmActivationStabilityChecking:
    ...
    def test_should_activate_algorithm_respects_stability_check(
        self, mock_hass, sample_config, sample_zone_configs
    ):
        ...
        assert (
            engine.should_turn_on_aircon(state_manager, HVACMode.HEAT, "dry") is False
        )

    def test_should_activate_algorithm_allows_after_stability_period(
        self, mock_hass, sample_config, sample_zone_configs
    ):
        ...
        assert engine.should_turn_on_aircon(state_manager, HVACMode.HEAT, "dry") is True

    def test_should_activate_algorithm_allows_with_no_previous_changes(
        self, mock_hass, sample_config, sample_zone_configs
    ):
    ...
    def test_should_activate_algorithm_mode_transitions(
        self, mock_hass, sample_config, sample_zone_configs
    ):
        ...
        assert engine.should_turn_on_aircon(state_manager, HVACMode.HEAT, "dry") is True
        assert engine.should_turn_on_aircon(state_manager, HVACMode.HEAT, "fan") is True
        assert engine.should_turn_on_aircon(state_manager, HVACMode.COOL, "dry") is True
        assert engine.should_turn_on_aircon(state_manager, HVACMode.COOL, "fan") is True

        # Should activate when switching between active modes
        assert (
            engine.should_turn_on_aircon(state_manager, HVACMode.HEAT, "cool") is True
        )
        assert (
            engine.should_turn_on_aircon(state_manager, HVACMode.COOL, "heat") is True
        )

        # Should not activate when already in target mode
        assert (
            engine.should_turn_on_aircon(state_manager, HVACMode.HEAT, "heat") is False
        )
        assert (
            engine.should_turn_on_aircon(state_manager, HVACMode.COOL, "cool") is False
        )

        # Should not activate for idle target modes
        assert (
            engine.should_turn_on_aircon(state_manager, HVACMode.DRY, "heat") is False
        )
        assert (
            engine.should_turn_on_aircon(state_manager, HVACMode.FAN, "cool") is False
        )
